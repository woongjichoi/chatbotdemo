...
//cart_view 자바 클래스는 무엇을 어떤 값에서 보여줄지를 설정해주는 역할


public class cart_view extends LinearLayout{
    ...
    public cart_view(Context context, cart_item aItem) {

        super(context);


        //보일 해당 listView에 들어갈 디자인 레이아웃 xml 설정(만들어진 cart_listitem.xml을 보일 디자인 레이아웃으로 설정하였음)

        LayoutInflater inflater = (LayoutInflater)

                context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);

        inflater.inflate(R.layout.cart_listitem, this, true);
    ...
    public cart_view(Context context, AttributeSet attrs) {
    ...
    public cart_view(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public cart_view(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
